...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 lg:px-20 bg-dark-400 text-white">
      <div className="container mx-auto px-4">
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <motion.div
            ...
            className="bg-dark-300 rounded-lg p-10 shadow-lg"
          >
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-primary-800 hover:bg-primary-600 p-3 rounded-full transition-colors duration-300"
                >
                  <svg
                ...
                <a
                  href="https://github.com/rahul-8000"
                  className="bg-primary-800 hover:bg-primary-600 p-3 rounded-full transition-colors duration-300"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="https://www.facebook.com/rahulkumawatr/"
                  className="bg-primary-800 hover:bg-primary-600 p-3 rounded-full transition-colors duration-300"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="https://www.instagram.com/_chhapoli/"
                  className="bg-primary-800 hover:bg-primary-600 p-3 rounded-full transition-colors duration-300"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 bg-dark-200 border border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500 text-white"
                  />
                </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-2 bg-dark-200 border border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500 text-white resize-none"
                ></textarea>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="pt-5 mt-5 border-t border-gray-700 text-center text-gray-500">
